<?php
    ...
    if ($result->num_rows > 0) {
        ...
        if($concurso != $concurso_resultado){
            ...
            dez_11, dez_12, dez_13, dez_14, dez_15, ganhadores_15_acertos, cidade_uf ) 
            VALUES ('$concurso_resultado', 
            ...
            '$numeros_array[13]', '$numeros_array[14]', '$numeroDeGanhadores_1', '$cidades_string', '$valorPremio_1')";
