...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function atualizarTabelaHistorico(nomeSocio) {
                $.ajax({
                    type: 'POST',
                    url: 'carrega_tabela-historico-mensalidades.php', // Nome do arquivo PHP que buscará os dados
                    data: {nome_socio: nomeSocio },
                    success: function(response) {
                        $('#tabela-historico-mensalidades').html(response); // Atualiza a tabela com os novos dados
                    }
                });
            }
            function atualizarTabelajoia(nomeSocio) {
                $.ajax({
                    type: 'POST',
                    url: 'carrega_tabela-joia.php', // Nome do arquivo PHP que buscará os dados
                    data: {nome_socio: nomeSocio },
                    success: function(response) {
            ...
            function atualizarTabelaHistoricojoia(nomeSocio) {
                $.ajax({
                    type: 'POST',
                    url: 'carrega_tabela-historico-joia.php', // Nome do arquivo PHP que buscará os dados
                    data: {nome_socio: nomeSocio },
                    success: function(response) {
                        $('#tabela-historico-joia').html(response); // Atualiza a tabela com os novos dados
                    }
                });
            }
...
<body>
    <h1>Relatório de Mensalidades á Pagar</h1>
    <p>
    ...
    <h1>Relatório de Mensalidades Pagas</h1>
    <div id="tabela-historico-mensalidades"></div>
