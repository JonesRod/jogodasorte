    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function atualizarTabela(vencimento, nomeSocio) {
                $.ajax({
                    type: 'POST',
                    url: 'atualizar_tabela-joia.php', // Nome do arquivo PHP que buscará os dados
...
<body>
    ...
    <h1>Relatório de Parcelas Pagas</h1>
    <div id="tabela-historico-joia"></div>
