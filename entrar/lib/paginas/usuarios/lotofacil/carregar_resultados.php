<?php
    ...
    $concursoEscolhido = $_GET['concurso']; // $concursoEscolhido recebe o valor 2954
    $conferirConcurso = $concursoEscolhido - 1; // $conferirConcurso recebe o valor 2955    
    ...
    if(isset($_SESSION['usuario'])){
        ...
        $sqlSorteado = "SELECT * FROM resultados_lotofacil WHERE numeros = $conferirConcurso";
        ...
        if ($resultSorteado->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                while ($rowSorteados = $result->fetch_assoc()) {
